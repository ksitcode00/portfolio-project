...
| [Household Air Pollution and Improved Cookstove Adoption in Rural Odisha](odisha-iaq-cookstove-r/) | Submitted environmental-health research project | Analyzed indoor air quality data comparing IDES and traditional cookstove households, with EDA, adjusted regression, logistic regression, mediation analysis, and causal-inference sensitivity checks. | R, data cleaning, EDA, log-linear regression, logistic regression, mediation, IPW, E-value sensitivity analysis, public-health interpretation |
