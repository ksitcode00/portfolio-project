...
This folder contains a GitHub-ready copy of my original R analysis workflow, but it does not include restricted research data or exact manuscript identifiers.

## What Is Included

- An adapted copy of the original R Markdown analysis file
- Documentation describing the research question, workflow, and interpretation in generalized language
- Placeholder paths showing where authorized data should be placed locally

## What Is Withheld

- Participant-level source data
- Cleaned study CSV files used in the restricted analysis environment
- Symptom-severity source files used in the restricted analysis environment
...
- Exact manuscript title, study site name, and population-specific labels in the GitHub-facing documentation
